...
namespace QDB
{
    ...
    private:
        ...
        /// @param op The update operator (e.g., "$set").
        /// @param field The field to apply the operator to.
        /// @param fv The value for the operation.
        ...
        /// @brief The internal map holding the update operations.
